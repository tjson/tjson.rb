    ...
    describe "#decode" do
      context "valid integer string" do
        ...
        it "parses successfully" do
          expect(subject.decode(example_string)).to eq example_integer
        end
      end
      ...
      context "oversized signed integer string" do
        ...
        it "raises TJSON::ParseError" do
          expect { subject.decode(oversized_example) }.to raise_error(TJSON::ParseError)
        end
      end
  ...
  describe TJSON::DataType::UnsignedInt do
    describe "#decode" do
      ...
      context "negative unsigned integer" do
        ...
        it "raises TJSON::ParseError" do
          expect { subject.decode(example_string) }.to raise_error(TJSON::ParseError)
        end
      end
    end
  end
