...
RSpec.context "Binary Data" do
  describe TJSON::DataType::Binary16 do
    ...
    context "valid base16 string" do
      ...
      it "parses successfully" do
        result = binary16.decode(example_base16)
    ...
    context "invalid base16 string" do
      ...
      it "raises TJSON::ParseError" do
        expect { binary16.decode(invalid_base16) }.to raise_error(TJSON::ParseError)
      end
    end
  end
  ...
  describe TJSON::DataType::Binary32 do
    ...
    context "valid base32 string" do
      ...
      it "parses successfully" do
        result = binary32.decode(example_base32)
        expect(result).to eq example_result
        expect(result.encoding).to eq Encoding::BINARY
      end
    end
    ...
    context "padded base32 string" do
      ...
      it "raises TJSON::ParseError" do
        expect { binary32.decode(padded_base32) }.to raise_error(TJSON::ParseError)
      end
    end
    ...
    context "invalid base32 string" do
      ...
      it "raises TJSON::ParseError" do
        expect { binary32.decode(invalid_base32) }.to raise_error(TJSON::ParseError)
      end
    end
  end
  ...
  describe TJSON::DataType::Binary64 do
    ...
    context "valid base64url string" do
      ...
      it "parses successfully" do
        result = binary64.decode(example_base64url)
        expect(result).to eq example_result
        expect(result.encoding).to eq Encoding::BINARY
      end
    end
    ...
    context "padded base64url string" do
      ...
      it "raises TJSON::ParseError" do
        expect { binary64.decode(padded_base64url) }.to raise_error(TJSON::ParseError)
      end
    end
    ...
    context "invalid base64url string" do
      ...
      it "raises TJSON::ParseError" do
        expect { binary64.decode(invalid_base64url) }.to raise_error(TJSON::ParseError)
      end
    end
  end
end
