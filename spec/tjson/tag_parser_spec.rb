...
RSpec.describe TJSON::TagParser do
  ...
  context "integers" do
    describe ".from_signed_int" do
      context "valid integer string" do
        let(:example_string)  { "42" }
        let(:example_integer) { 42 }

        it "parses successfully" do
          expect(described_class.from_signed_int(example_string)).to eq example_integer
        end
      end
      ...
      context "oversized signed integer string" do
        ...
        it "raises TJSON::ParseError" do
          expect { described_class.from_signed_int(oversized_example) }.to raise_error(TJSON::ParseError)
        end
      end
    ...
    describe ".from_unsigned_int" do
      context "valid integer string" do
        let(:example_string)  { "42" }
        let(:example_integer) { 42 }

        it "parses successfully" do
          expect(described_class.from_unsigned_int(example_string)).to eq example_integer
        end
      end
      ...
      context "oversized unsigned integer string" do
        ...
        it "raises TJSON::ParseError" do
          expect { described_class.from_unsigned_int(oversized_example) }.to raise_error(TJSON::ParseError)
        end
      end
      ...
      context "negative unsigned integer" do
        ...
        it "raises TJSON::ParseError" do
          expect { described_class.from_unsigned_int(example_string) }.to raise_error(TJSON::ParseError)
        end
      end
    end
  end
